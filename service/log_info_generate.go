...
func appendClientDisconnectStatus(relayInfo *relaycommon.RelayInfo, other *model.LogOther) {
	...
	other.SetPublic("client_disconnected", true)
	if relayInfo.ClientDisconnectedAtMs > 0 {
		other.SetPublic("client_disconnected_at_ms", relayInfo.ClientDisconnectedAtMs)
	}
}
